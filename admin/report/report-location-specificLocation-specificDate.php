...
if (isset($_POST['report-location-specificLocation-specificDate'])) {
    ...
    $locations = $model->getInventorySpecificLocationSpecificDateReport($location, $fromDate, $toDate);
    ...
    $filename = 'Locations-Report-' . $locationName . '-Between-' . $fromDate . '-' . $toDate . '.xlsx'; // Specify the file name
