...
if (isset($_POST['report-inventory-allRemark-specificDate'])) {
    $fromDate = $_POST['from_date'];
    $toDate = $_POST['to_date'];
    $session_name = $_POST['session_name']; // Session name
    $assignedItems = $model->getInvAllRemarkSpecificDateReport($fromDate, $toDate);
    ...
    $logoWidth = 120; // Width of the logo
    ...
    $sheet->getStyle('B8')->getFont()->setBold(true);
     ...
     $sheet->setCellValue('B9', '______All Inventory Remarks_____');
    ...
    $filename = 'Inventory-Report-Overall-Between-' . $fromDate . '-' . $toDate . '.xlsx'; // Specify the file name
