...
if (isset($_POST['report-category-specificCategory-specificDate'])) {
    ...
    $categories = $model->getInventorySpecificCategorySpecificDateReport($category, $fromDate, $toDate);
    ...
    $sheet->getStyle('B8')->getFont()->setBold(true);
     ...
     $sheet->setCellValue('B9', '______' . $categoryName . '_____');
    ...
    $filename = 'Inventory-Report-' . $categoryName . '-Between-' . $fromDate . '-' . $toDate . '.xlsx'; // Specify the file name
