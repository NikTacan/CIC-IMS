...
if (isset($_POST['report-category-specificCategory-allDate'])) {
    ...
    $categories = $model->getInventorySpecificCategoryAllDateReport($category);
    ...
    $filename = 'Category-Report-' . $categoryName. '-' . $date_now . '.xlsx'; // Specify the file name
