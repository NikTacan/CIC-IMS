...
if (isset($_POST['report-category-allCategory-allDate'])) {
    $session_name = $_POST['session_name']; // Session name

    $inventories = $model->getAllInventoryOrderByCategory();
    ...
    $filename = 'Inventory-Report-Overall-Category-' . $date_now . '.xlsx'; // Specify the file name
