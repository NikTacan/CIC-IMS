...
if (isset($_POST['report-location-allLocation-allDate'])) {
    $session_name = $_POST['session_name']; // Session name
    $locations = $model->getInventoryAllLocationAllDate();
    ...
    $sheet->getStyle('B8')->getFont()->setBold(true);
     ...
     $sheet->setCellValue('B9', '______Overall Location_____');
    ...
    $filename = 'Inventory-Report-Overall-Location-' . $date_now . '.xlsx'; // Specify the file name
