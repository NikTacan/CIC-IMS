...
if (isset($_POST['report-inventory-allRemark-allDate'])) {
    $session_name = $_POST['session_name']; // Session name
    $assignedItems = $model->displayInventoryWithDetails();
    ...
    $filename = 'Inventory-Report-All-' . $date_now . '.xlsx'; // Specify the file name
