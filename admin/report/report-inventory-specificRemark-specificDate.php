...
if (isset($_POST['report-inventory-specificRemark-specificDate'])) {
    ...
    $assignedItems = $model->getInvSpecificRemarkSpecificDateReport($note_id, $fromDate ,$toDate);
    ...
    $filename = 'Inventory-Report-' . $remarks  . '-Between-' . $fromDate . '-' . $toDate . '.xlsx'; // Specify the file name
